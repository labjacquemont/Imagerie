...
root_p = pal.Path('../../')
pheno_p = root_p / 'data/pheno/Pheno_16p.csv'
connectome_p = root_p / 'data/preprocessed/connectome/16p_connectome/niak/'
connectome_t = 'connectome_{}_cambridge64.mat'
connectome_n = 'mean_con'
out_p = root_p / 'data/preprocessed/connectome/16p_connectome/python/'
if not out_p.is_dir():
    out_p.mkdir()
