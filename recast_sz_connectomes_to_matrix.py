...
root_p = pal.Path('../../')
pheno_p = root_p / 'data/pheno/schizo_orga_multiple_clinical_scores.csv'
connectome_p = root_p / 'data/preprocessed/connectome/cobre_connectome/niak/'
connectome_t = 'connectome_s{}_cambridge64.mat'
connectome_n = 'sz_c'
out_p = root_p / 'data/preprocessed/connectome/cobre_connectome/python/'
if not out_p.is_dir():
    out_p.mkdir()
