...
pheno_p = root_p / 'pheno/Pheno_ABIDE.csv'
connectome_p = root_p / 'preprocessed/connectome/abide_connectome/python/'
...
# Control the ABIDE connectomes for nuisance covariates
...
np.save(out_p / 'icc_residual_connectomes_abide.npy', resid)
# Store the list of subjects used to generate the connectomes
with (out_p / 'icc_subjects_included_in_residual_connectomes_abide.tsv').open('w') as f:
