...
profile_p = root_p / 'processed/fc_profiles/cnv_16p_del_vs_con.tsv'
connectomes_p = root_p / 'processed/residual_connectomes/icc_residual_connectomes_abide.npy'
...
np.save(out_p / 'icc_16p_weights_abide.npy', w)
